...
redshifts, moduli, noise_data, keyword = read_data(keyword="Pantheon+", from_pickle_directory=True) if not use_union_data else read_data(keyword="Union2.1", from_pickle_directory=True)
...
fluctuations_info = f"fluct_{args['fluctuations']}"
...
posterior_realizations = unpickle_me_this("realdata_Union2.1_posterior_realizations_fluct_(1, 1e-16).pickle")
...
print("mean found parameters :",k_mean,k_std,flucts_mean,flucts_std)
